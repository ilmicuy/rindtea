                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-8 text-end">
                        <ul class="mb-5 text-center nav nav-pills d-inline-flex">
                            ...
                            <li class="nav-item">
                                <a class="py-2 m-2 d-flex bg-light rounded-pill" data-bs-toggle="pill" href="#tab-2">
                                    <span class="text-dark" style="width: 130px;">Vegetables</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="py-2 m-2 d-flex bg-light rounded-pill" data-bs-toggle="pill" href="#tab-3">
                                    <span class="text-dark" style="width: 130px;">Fruits</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="py-2 m-2 d-flex bg-light rounded-pill" data-bs-toggle="pill" href="#tab-4">
                                    <span class="text-dark" style="width: 130px;">Bread</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="py-2 m-2 d-flex bg-light rounded-pill" data-bs-toggle="pill" href="#tab-5">
