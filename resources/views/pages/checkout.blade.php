                                ...
                                <tr>
                                    ...
                                    <th scope="row">
                                        <div class="product-image">
                                            <img src="{{ Storage::url($checkout->product->photos) }}" class="product-img"
                                                alt="">
                                        </div>
                                    </th>
                        ...
                        <div class="shipping-section">
                            ...
                            <div class="courier-options d-flex justify-content-start">
                                <div class="shipping-option d-flex align-items-center mr-4">
                                    <input class="courier-code" type="radio" name="courier" id="inlineRadio1"
                                        value="jne">
                                    <label class="courier-label ml-2" for="inlineRadio1">JNE</label>
                                </div>
                                <div class="shipping-option d-flex align-items-center mr-4">
                                    <input class="courier-code" type="radio" name="courier" id="inlineRadio2"
                                        value="pos">
                                    <label class="courier-label ml-2" for="inlineRadio2">POS</label>
                                </div>
                                <div class="shipping-option d-flex align-items-center">
                                    <input class="courier-code" type="radio" name="courier" id="inlineRadio3"
                                        value="tiki">
