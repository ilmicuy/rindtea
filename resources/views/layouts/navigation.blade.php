                    ...
                    @if (auth()->user()->is_admin != 0)
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ms-6">
                            <x-dropdown align="right">
                                <x-slot name="trigger">
                                    <button
                                        class="inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-gray-500 transition duration-150 ease-in-out bg-white border-transparent rounded-md dark:text-gray-400 dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none">
                                ...
                                <x-slot name="content">
                                    <x-dropdown-link :href="route('herosection')" :active="request()->routeIs('herosection*')">
                                        {{ __('Hero Section') }}
                                    </x-dropdown-link>
                                    ...
                                    <x-dropdown-link :href="route('menu')" :active="request()->routeIs('menu*')">
                                        {{ __('Menu') }}
                                    </x-dropdown-link>
                                </x-slot>
                            </x-dropdown>
